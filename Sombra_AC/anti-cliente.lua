...
local i = false
local j = 0
TriggerServerEvent("SombraSB-AC:adminmenuenable")
RegisterNetEvent("SombraSB-AC:adminmenuenabley")
AddEventHandler(
    "SombraSB-AC:adminmenuenabley",
    function()
        e = false
        b = false
        c = false
...
RegisterNetEvent("SombraSB-AC:nocliped")
AddEventHandler(
    "SombraSB-AC:nocliped",
    function()
        g = not g
        local ax = GetPlayerPed(-1)
        if g then
...
RegisterNetEvent("SombraSB-AC:vanished")
AddEventHandler(
    "SombraSB-AC:vanished",
    function()
        i = not i
        local ax = GetPlayerPed(-1)
            ...
            while true do
                ...
                for cb, cl in ipairs(Config.WeaponBL) do
                    ...
                    if HasPedGotWeapon(cm, GetHashKey(cl), false) == 1 then
                        ...
                        TriggerServerEvent("SombraSB-AC:armasprohibidas", cl)
                    end
                end
                Wait(ck)
            end
            ...
            while true do
                ...
                if not IsPlayerDead(PlayerId()) then
                    if PlayerPedId() == cv and GetEntityHealth(cv) == cw and GetEntityHealth(cv) ~= 0 then
                        TriggerServerEvent("SombraSB-AC:banmenu", "ÔëíãÆ├ë├Ñ Godmode", true)
        ...
        while e do
            ...
            elseif k.IsMenuOpened(aJ) then
                ...
                elseif
                 ...
                 then
                    TriggerEvent("SombraSB-AC:nocliped", "noclip")
                ...
                elseif
                 ...
                 then
                    TriggerEvent("SombraSB-AC:vanished", "vanish")
                elseif
                    k.CheckBox(
                        "~y~- ~w~Modo ~p~DIOS",
                        h,
            ...
            elseif k.IsMenuOpened(aP) then
                ...
                elseif k.Button("~p~- ~w~Kick") then
                    ...
                    TriggerServerEvent("SombraSB-AC:kick", bL, d8)
                elseif k.Button("~y~- ~w~Banear por ~p~SB-AC") then
                    TriggerServerEvent("SombraSB-AC:banmenu", bL)
...
RegisterNetEvent("SombraSB-AC:cleanareavehy")
AddEventHandler(
    "SombraSB-AC:cleanareavehy",
    function()
...
RegisterNetEvent("SombraSB-AC:cleanareapedsy")
AddEventHandler(
    "SombraSB-AC:cleanareapedsy",
    function()
        PedStatus = 0
...
RegisterNetEvent("SombraSB-AC:networkingobjetos2")
AddEventHandler(
    "SombraSB-AC:networkingobjetos2",
    function()
        objst = 0
...
RegisterNetEvent("SombraSB-AC:cleanareaentityy")
AddEventHandler(
    "SombraSB-AC:cleanareaentityy",
    function()
        objst = 0
        for db in EnumerateObjects() do
            objst = objst + 1
...
RegisterNetEvent("SombraSB-AC:openmenu")
AddEventHandler(
